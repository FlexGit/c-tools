                        ...
                        <blockquote class="block-47-quote">
                            <p>
                                <a class="image-popup" href="{{ asset('storage/' . $certificate->image) }}">
                                    <img src="{{ asset('storage/' . $certificate->image) }}" alt="{{ $certificate->title }}" width="300" height="auto">
                                </a>
                            </p>
                            {{--<cite class="block-47-quote-author">&mdash; {{ $certificate->title }}</cite>--}}
                        </blockquote>
                    </div>
                </div>
            @endforeach
...
<div class="site-block-half d-block d-lg-flex bg-light" data-aos="fade">
    ...
    <div class="text order-1">
        <h2 class="text-black mb-3">Адрес <strong>офиса</strong></h2>
...
<div class="site-block-half d-block d-lg-flex bg-light" data-aos="fade">
    ...
    <div class="text order-2">
        <h2 class="text-black mb-3">Адрес <strong>производства</strong></h2>
...
<div class="site-block-half d-block d-lg-flex bg-light" data-aos="fade">
    ...
    <div class="text order-1">
        <h2 class="text-black mb-3">Адрес <strong>склада</strong></h2>
        @if (isset($settingItems['manufacture-address']))
            <p class="lead">
