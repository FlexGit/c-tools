...
return [
    ...
    */
    ...
    'profiles' => [
        ...
        'default' => [
            'plugins' => 'advlist autoresize directionality emoticons fullscreen hr image imagetools link lists media table toc code',
            'toolbar' => 'undo redo removeformat | formatselect fontsizeselect | bold italic | rtl ltr | alignjustify alignright aligncenter alignleft | numlist bullist | forecolor backcolor | blockquote table toc hr | image link media emoticons | wordcount fullscreen | code',
